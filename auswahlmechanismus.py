...
def daemmung_wahl():
    ...
    while korrekte_eingabe == False:
        ...
        print ("Welche Gebäudekomponente soll gedämmt werden?\n 1 - Wände\n 2 - Dach\n 3 - Kellerboden\n "
               "4 - Fenster und Türen\n 5 - alles\n 6 - Betrachtung des ungedämmten Altbaus\n Bestätigen Sie Ihre Eingabe mithilfe der Enter-Taste")

        komponente = input("Komponente: ")
        if komponente == "1":
            print ("\nDämmung der Wände durch Styroporschicht der Dicke \n a - 6cm\n b - 10cm\n c - 15cm")
            maßnahme = input("Variante: ")
            status_styropor_wand, korrekte_eingabe, s_styropor = s_styropor_wahl()
            ...
            print("\nEs wird eine Dämmung sämtlicher Komponenten durch 15cm dickes Styropor und Dreifachverbundglas vorgenommen")
